 ...
 */
export async function planScenes(storyText, durationRange, gameContext, voiceDesc, heroDesc, images = {}, allowedDurations = [], pipelineMode = 'standard', heroesData = null) {
...
IMPORTANT: You MUST create at least 2 scenes. The total of all durations MUST be between ${durMin} and ${durMax} seconds.`;
  ...
  console.log(`[Claude] Planning scenes (${durMin}-${durMax}s) with claude-sonnet-4-6... (voice: ${voiceDesc ? 'user-provided' : 'auto-generate'}, heroImg: ${hasHeroImage}, bgImg: ${hasBgImage}, heroCatalog: ${heroesData?.heroes?.length ?? 0} heroes)`);
