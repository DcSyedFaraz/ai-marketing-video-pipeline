...
- VARY these details (do NOT use the same look each time):
  ...
  * Accessories (small earring, chain necklace, wristband, gaming pin, etc.)
- MUST INCLUDE: Gaming headset with large ear cups resting around neck
- MUST INCLUDE: Leaning slightly forward toward a large professional black studio condenser microphone on a boom arm, mid-sentence with mouth slightly open, EYES LOOKING DIRECTLY INTO THE CAMERA
