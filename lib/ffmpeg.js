 ...
 * Processes only 2 clips at a time to keep memory usage low (avoids SIGKILL on Railway/Cloud Run).
 * Uses hard cuts between clips — xfade with many clips requires all in memory at once.
