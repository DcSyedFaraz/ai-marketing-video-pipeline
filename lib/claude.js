...
- Guest caught MID-ACTIVITY — waiting, leaning against a wall, sitting on a bench, on lunch break. Guest must NOT be holding or using a phone in Scene 1. Phone must stay in pocket until the proof scene.
...
- Phone must NOT appear in Scene 1. Guest has NO phone visible at the start — phone stays in pocket.
- Phone comes out ONCE in the proof scene — guest reaches into pocket and pulls it out naturally mid-conversation.
...
- NEVER show the guest with a phone before the proof scene. The phone reveal IS the moment.
...
SCENE 1 — HOOK: Interviewer mid-run approaching guest. Guest caught mid-activity — NO phone visible, phone in pocket. Shaky handheld camera following. Street noise. No music. Guest pulls earbud out. Interviewer asks a quick question (under 10 words).
${sceneCount === 4
  ? `SCENE 2 — DISCOVERY: Guest casually mentions Blitz of Battle. Short rapid exchange. Music enters on the reaction. Handheld two-shot. Still no phone visible.
SCENE 3 — PROOF: Guest reaches into pocket and pulls phone out for the FIRST TIME — landscape, two-handed grip, screen facing outward with soft glow. Do NOT describe what is on the game screen. Camera catches phone then pulls back to two-shot. Quick impressed reaction from interviewer.`
  : `SCENE 2 — DISCOVERY+PROOF: Guest mentions Blitz of Battle, reaches into pocket and pulls phone out for the FIRST TIME — landscape grip, screen facing outward with soft glow. Do NOT describe game screen contents. Music enters. Camera catches phone. Quick exchange.`}
...
━━━ GAME SCREEN RULE (CRITICAL) ━━━
Do NOT describe what is on the phone screen. No gameplay details, no arena, no UI, no icons, no heroes. Just say "screen glowing" or "soft screen glow" — the reference image handles the rest.

━━━ NEGATIVE PROMPT (ALWAYS INCLUDE AT END) ━━━
NEGATIVE PROMPT: news microphone, foam microphone, branded microphone, portrait phone, vertical phone, back of phone visible, phone screen blank, game screen description, gameplay UI description, phone visible in Scene 1, guest holding phone at start, guest scrolling phone at start, colosseum, Roman arena, tall arena walls, giant heroes, side-view arena, theatrical reactions, robotic delivery, studio lighting, text overlays, finger gestures, pointing, slow motion, blurry faces, distorted hands, crowd reacting to interview, music before Scene 2, artificial pauses, staged positioning, phone raised to eye level, revealing clothing
...
script: MUST be under 2500 characters. Keep it tight — short punchy scene descriptions. suggestedDuration: exactly ${dur}.`;

  const exampleScript = sceneCount === 4
    ? `{"script": "SCENE 1 — 3s. Busy sidewalk near taco truck, warm afternoon sun. Handheld camera bouncing — interviewer jogging toward a guy leaning against a lamppost, arms crossed, earbuds in. Street noise, traffic, people walking. Western male interviewer, 24, grey hoodie, messy hair, no mic. Western male guest, 27, black cap backwards, olive jacket — pulls earbud out mid-approach. Interviewer, out of breath, slow clear delivery: \\"What do you do with five minutes?\\" Guest glances up, half-smile. No music — street noise only. Warm golden grade. SCENE 2 — 3s. Same spot, loose handheld two-shot. Guest shrugs, slow clear delivery: \\"Blitz of Battle.\\" Interviewer eyebrows up — overlapping, slow clear delivery: \\"On your phone?\\" Lo-fi beat fades in soft. Warm tones, shallow depth. SCENE 3 — 3s. Guest reaches into jacket pocket, pulls phone out for the first time — landscape, two-handed grip, screen facing outward at lower chest, soft screen glow on face. Camera dips to phone then pulls back to two-shot. Interviewer leans in, impressed. Lo-fi beat steady. Natural daylight. SCENE 4 — 3s. Camera pulls back wider, loose handheld. Interviewer, slow clear delivery: \\"How long's a match?\\" Guest, instant, slow clear delivery: \\"Three minutes.\\" Interviewer, quiet: \\"Three minutes?\\" Guest nods, slight grin: \\"Three minutes.\\" Beat drops to silence. Single soft chord. Traffic passes behind. NEGATIVE PROMPT: news microphone, foam microphone, branded microphone, portrait phone, vertical phone, back of phone visible, phone screen blank, game screen description, gameplay UI description, phone visible in Scene 1, guest holding phone at start, guest scrolling phone at start, colosseum, Roman arena, tall arena walls, giant heroes, side-view arena, theatrical reactions, robotic delivery, studio lighting, text overlays, finger gestures, pointing, slow motion, blurry faces, distorted hands, crowd reacting to interview, music before Scene 2, artificial pauses, staged positioning, phone raised to eye level, revealing clothing", "suggestedDuration": 12, "refHint": "Attach a landscape gameplay screenshot in Extra Refs — Seedance uses it for the phone screen in Scene 3."}`
    : `{"script": "SCENE 1 — 3s. Park bench near food cart, overcast afternoon. Handheld camera bouncing — interviewer walking fast toward a woman on the bench, earbuds in, arms on her tote bag. Street noise, pigeons, distant traffic. Western male interviewer, 25, flannel shirt, jeans, no mic. Western female guest, 23, denim jacket — pulls earbud out. Interviewer, breathless, slow clear delivery: \\"What's on your phone right now?\\" Guest looks up, half-laugh. No music — ambient only. Cool overcast grade. SCENE 2 — 5s. Same bench, loose handheld two-shot. Guest grins, slow clear delivery: \\"Blitz of Battle.\\" Reaches into jacket pocket, pulls phone out for the first time — landscape, two-handed grip, screen out at chest level, soft glow on face. Lo-fi beat fades in. Camera catches phone then pulls to two-shot. Interviewer, impressed, slow clear delivery: \\"How long's a match?\\" Natural light on both. SCENE 3 — 3s. Camera pulls back wider. Guest, instant, slow clear delivery: \\"Three minutes.\\" Interviewer, quiet: \\"Three minutes?\\" Guest nods, slight smile: \\"Three minutes.\\" Beat drops to silence. Single soft chord. Camera holds wide. Bus passes behind. NEGATIVE PROMPT: news microphone, foam microphone, branded microphone, portrait phone, vertical phone, back of phone visible, phone screen blank, game screen description, gameplay UI description, phone visible in Scene 1, guest holding phone at start, guest scrolling phone at start, colosseum, Roman arena, tall arena walls, giant heroes, side-view arena, theatrical reactions, robotic delivery, studio lighting, text overlays, finger gestures, pointing, slow motion, blurry faces, distorted hands, crowd reacting to interview, music before Scene 2, artificial pauses, staged positioning, phone raised to eye level, revealing clothing", "suggestedDuration": 11, "refHint": "Attach a landscape gameplay screenshot in Extra Refs — Seedance uses it for the phone screen in Scene 2."}`;
